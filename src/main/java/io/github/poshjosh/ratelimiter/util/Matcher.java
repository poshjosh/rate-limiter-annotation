...
public interface Matcher<I, O> {
  ...
  /**
   * Returns a composed {@code Matcher}. The returned Matcher will return the result of the first
   * match, only if both matchers succeed otherwise it return's <code>null</code>.
   *
